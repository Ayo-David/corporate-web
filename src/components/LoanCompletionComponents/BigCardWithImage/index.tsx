...
interface IBigCardWithImageProps {
  dataList: any;
  color: string;
}

const BigCardWithImage: React.FunctionComponent<IBigCardWithImageProps> = (props) => {
  ...
  return (
    <NavLink to={`/deal-sheets/${props.dataList.id}`} className="big-card">
      <div className="top">

...
interface IPersonalCurrentAccountPremiumProps {
...
const PersonalCurrentAccountPremium: React.FunctionComponent<IPersonalCurrentAccountPremiumProps> =
  (props) => {
    ...
    useEffect(() => {
      ...
      nprogress.start();
      props.dataAction.getPersonalCurrentAccountsContentData();
